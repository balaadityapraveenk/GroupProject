    ...
    static void createSamplesIfMissing() {
        try {
            ...
            try (FileWriter w1 = new FileWriter("routes.csv");
                ...
                w1.write("R024,Vijayawada,Sri Sathya Sai ,522\n");
...
public class TransportAndLogistics {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("1. Our Rules and Policies.");
            System.out.println("2. List Routes");
            System.out.println("3. Select Route,Vehicle and Calculate Cost");
            System.out.println("4. Track Your Parcel.");
            ...
            switch (choice) {
                case 1:
                    System.out.println("Rules and Policies:-\n"+"1.Fireworks are not allowed.\n"+"2.Fragile Items must be mentioned before the shipment");
                    System.out.println("3.We are responsible for any damage to your parcel during Shipment(but conditions apply)\n");
                    break;
                case 2:
                ...
                case 4:
                    ...
                    if (matcher.matches()) {
                        ...
                        String shipmentid = s.nextLine();
                        String r = "^\\d{4}$";

                        Pattern p = Pattern.compile(r);
                        Matcher m = pattern.matcher(shipmentid);
                        if (m.matches()) {
                            System.out.println("Your Parcel is tracked successfully. The details regarding parcel will be shared through SMS.");
                        }
                        else{
                            System.out.println("Enter valid Shipment ID.");
                        }
                    }else {
